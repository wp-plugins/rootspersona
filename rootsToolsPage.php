...
echo  "<td><div class='rp_linkbutton'><a href=' " . site_url() . "?page_id=" . get_option('rootsCreatePage') . "'>" . __('Add Uploaded Persons') . "</a></div></td>";
echo  "<td style='vertical-align:middle'>" . __('Review the list of people you have uploaded but not created pages for.') . "</td></tr>";

echo  "<tr style='vertical-align: top'>";
echo  "<td><div class='rp_linkbutton'><a href=' " . site_url() . "?page_id=" . get_option('rootsUploadGedcomPage') . "'>" . __('Upload GEDCOM') . "</a></div></td>";
echo  "<td style='vertical-align:middle'>" . __('Upload (or re-upload) a gedcom file.') . "</td></tr>";

echo  "<tr style='vertical-align: top'>";
echo  "<td><div class='rp_linkbutton'><a href=' " . site_url() . "?page_id=" . get_option('rootsIncludePage') . "'>" . __('Review Excluded Persons') . "</a></div></td>";
echo  "<td style='vertical-align:middle'>" . __('Review people you have previous excluded, and include the ones you select.') . "</td></tr>";

echo  "<tr style='vertical-align: top'>";
echo  "<td><div class='rp_linkbutton'><a href=' " . site_url() . "?page_id=" . get_option('rootsPersonaIndexPage') . "'>" . __('Name Index') . "</a></div></td>";
