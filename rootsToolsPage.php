...
echo  "<td style='vertical-align:middle'>" . sprintf(__('Validate your %s setup. Confirms the mapping file used to track pages is not corrupt.', 'rootspersona'),"rootsPersona") . "</td></tr>";
...
echo  "<td style='vertical-align:middle'>" . sprintf(__('Identify orphaned %s pages. Includes all pages with %s shortcode and no reference in idMap.xml.', 'rootspersona'),"persona","[rootsPersona/]") . "</td></tr>";
...
echo  "<td style='vertical-align:middle'>" . sprintf(__('Perform a bulk deletion of all %s pages.  Only deletes pages with the main %s shortcode.', 'rootspersona'),"persona","[rootsPersona/]") . "</td></tr>";
