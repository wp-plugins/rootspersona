...
class RP_Ancestors_Panel_Creator {
	...
	public static function create( $ancestors, $options ) {
		...
		$block = '<section class="rp_truncate">'
                ...
                . RP_Ancestors_Panel_Creator::buildBlock($ancestors[4], $options, $fname, $ancestors[2], 1);
		...
		$block .= '</td></tr>' . '<tr><td class="rp_topleft" style="border-color:' . $pframe_color . ' !important">&#160;</td></tr>'
                . '<tr><td>&#160;</td>'
                . '<td rowspan="2" class="rp_nameBox" style="border-color:' . $pframe_color . ' !important">'
                . RP_Ancestors_Panel_Creator::buildBlock($ancestors[2], $options, $fname, $ancestors[1], 1);
		...
		$block .= '</td><td class="rp_bottom" style="border-color:' . $pframe_color . ' !important">&#160;</td><td colspan="2" rowspan="2" class="rp_left" style="border-color:' . $pframe_color . ' !important">&#160;</td></tr>'
                ...
                . '<td rowspan="2" class="rp_nameBox" style="border-color:' . $pframe_color . ' !important">'
                . RP_Ancestors_Panel_Creator::buildBlock($ancestors[5], $options, $fname, $ancestors[2], 2);

        $block .= '</td></tr>'
                . '<tr><td>&#160;</td></tr><tr><td rowspan="2" class="rp_nameBox" style="border-color:' . $pframe_color . ' !important">'
                . RP_Ancestors_Panel_Creator::buildBlock($ancestors[1], $options, $ancestors[1]->full_name, null, null);
        ...
        $block .= '</td><td class="rp_bottom" style="border-color:' . $pframe_color . ' !important">&#160;</td><td colspan="2" rowspan="2">&#160;</td></tr>'
                ...
                . RP_Ancestors_Panel_Creator::buildBlock($ancestors[6], $options, $fname, $ancestors[3], 1);
        ...
        $block .= '</td></tr><tr><td class="rp_topleft" style="border-color:' . $pframe_color . ' !important">&#160;</td></tr>'
                ...
                . RP_Ancestors_Panel_Creator::buildBlock($ancestors[3], $options, $fname, $ancestors[1], 2);
		...
		$block .= '</td><td class="rp_bottom" style="border-color:' . $pframe_color . ' !important">&#160;</td><td colspan="2" rowspan="2" class="rp_left" style="border-color:' . $pframe_color . ' !important">&#160;</td></tr>'
                ...
                . RP_Ancestors_Panel_Creator::buildBlock($ancestors[7], $options, $fname, $ancestors[3], 2);
    ...
    public static function buildBlock($ancestor, $options, $full_name, $descendant, $sseq) {
        ...
        if ( $full_name != '?' && $full_name != '+' ) {
            ...
            $block .= '<a href="'
                    ...
                    . $descendant->famc . '&child=' . $descendant->id . '&sseq=' . $sseq
                    . '">';
        }
