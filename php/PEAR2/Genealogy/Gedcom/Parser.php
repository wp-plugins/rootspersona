...
class Parser
{
    ...
    {
        $rec = new Records\SubmissionRecord();
    ...
    {
        $rec = new Records\IndividualRecord();
        $rec->parseTree(array($tree), $this->gedcomVersion);
    ...
    {
        $rec = new Records\RepositoryRecord();
        $rec->parseTree(array($tree), $this->gedcomVersion);
    ...
    {
        $rec = new Records\SubmitterRecord();
        $rec->parseTree(array($tree), $this->gedcomVersion);
