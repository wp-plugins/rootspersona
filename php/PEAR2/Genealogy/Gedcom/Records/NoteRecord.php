<?php
/**
 * PEAR2\Genealogy\Gedcom\Records\NoteRecord
 *
 * PHP version 5
 *
...
/**
 * NoteRecord class for PEAR2_Genealogy_Gedcom
 *
 * @category  File_Formats
 * @package   PEAR2_Genealogy_Gedcom_Records
 * @author    Ed Thompson <ed4becky@gmail.com>
...
class NoteRecord extends EntityAbstract
{
    ...
    {
        $this->Id = parent::parseRefId($tree[0], Tags::NOTE);
        $this->Text = parent::parseConTag($tree[0], Tags::NOTE);
        $lvl2 = $lvl + 1;
        if (isset($tree[0][1])) {
            $sub2 = $tree[0][1];
