<?php
/**
 * PEAR2\Genealogy\Gedcom\Records\IndividualRecord
 *
 * PHP version 5
 *
 *
...
/**
 * IndividualRecord class for PEAR2_Genealogy_Gedcom
 *
 * @category  File_Formats
 * @package   PEAR2_Genealogy_Gedcom_Records
 * @author    Ed Thompson <ed4becky@gmail.com>
    ...
    public function parseTree($tree, $ver)
    {
        ...
        if (isset($tree[0][1])) {
            ...
            while (($i1=parent::findTag($sub2, Tags::FULL, $off))!==false) {
                $tmp = new Structures\PersonalName();
            ...
            while (($i1=parent::findTag($sub2, Tags::ASSOCIATION, $off))!==false) {
                $tmp = new Structures\Association();
                $tmp->parseTree(array($sub2[$i1]), $ver);
