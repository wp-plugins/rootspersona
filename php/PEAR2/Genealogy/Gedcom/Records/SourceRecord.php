<?php
/**
 * PEAR2\Genealogy\Gedcom\Records\SourceRecord
 *
 * PHP version 5
 *
...
/**
 * SourceRecord class for PEAR2_Genealogy_Gedcom
 *
 * @category  File_Formats
 * @package   PEAR2_Genealogy_Gedcom_Records
 * @author    Ed Thompson <ed4becky@gmail.com>
    ...
    public function parseTree($tree, $ver)
    {
        ...
        if (isset($tree[0][1])) {
            ...
            while (($i1=parent::findTag($sub2, Tags::REPOSITORY, $off))!==false) {
                $tmp = new Structures\RepositoryCitation();
                $tmp->parseTree(array($sub2[$i1]), $ver);
