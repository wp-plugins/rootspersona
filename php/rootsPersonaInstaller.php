...
class rootsPersonaInstaller {
        function rootsPersonaInstall ($version) {
            	...
            	if(!is_dir(WP_CONTENT_DIR ."/rootsPersonaData/")) {
            		...
            		rename(ABSPATH . $this->plugin_dir . "/rootsData/p000.xml", WP_CONTENT_DIR ."/rootsPersonaData/p000.xml");
            		rename(ABSPATH . $this->plugin_dir . "/rootsData/f000.xml", WP_CONTENT_DIR ."/rootsPersonaData/f000.xml");
            		rename(ABSPATH . $this->plugin_dir . "/rootsData/templatePerson.xml", WP_CONTENT_DIR ."/rootsPersonaData/templatePerson.xml");
            		rename(ABSPATH . $this->plugin_dir . "/rootsData/README.txt", WP_CONTENT_DIR ."/rootsPersonaData/README.txt");
            	}
            	add_option('rootsDataDir', "wp-content/rootsPersonaData/");
            	
            	$page = $this->createPage('Edit Person Page','[rootsEditPersonaForm/]',$page);
        ...
        function rootsPersonaUpgrade($version) {
